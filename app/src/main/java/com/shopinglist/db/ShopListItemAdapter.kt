...
import com.shopinglist.databinding.ListNameItemBinding
import com.shopinglist.databinding.ShopLibraryItemBinding
import com.shopinglist.databinding.ShopListItemBinding
    ...
    class ItemHolder(val view: View): RecyclerView.ViewHolder(view){
        ...
        companion object{
            ...
            fun createLibraryItem(parent: ViewGroup): ItemHolder{
                return ItemHolder(LayoutInflater.from(parent.context).inflate(R.layout.shop_library_item, parent, false))
            }
        }
    }
